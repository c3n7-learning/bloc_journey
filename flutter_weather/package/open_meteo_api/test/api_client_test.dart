...
void main() {
  group('OpenMeteoApiClient', () {
    ...
    group('locationSearch', () {
      ...
      test('throws LocationRequestFailure on non-200 respone', () async {
        final response = MockResponse();
      ...
      test('throws LocationNotFoundFailure on empty respone', () async {
        final response = MockResponse();
        when(() => response.statusCode).thenReturn(200);
      ...
      test('returns Location on valid respons', () async {
        final response = MockResponse();
        when(() => response.statusCode).thenReturn(200);
        when(() => response.body).thenReturn('''
{
  "results": [
    ...
    group('getWeather', () {
      ...
      test('returns weather on valid respons', () async {
        final response = MockResponse();
        when(() => response.statusCode).thenReturn(200);
        when(() => response.body).thenReturn(
          '''
